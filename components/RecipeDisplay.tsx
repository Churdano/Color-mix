  ...
  return (
    <div className="glass-panel rounded-2xl overflow-hidden shadow-2xl mt-8 animate-fade-in-up ring-1 ring-orange-500/10">
      ...
      <div className="p-8 bg-stone-900/60 border-t border-white/5">
          ...
          {recipe.matchAccuracy <= 80 && recipe.suggestions && recipe.suggestions.length > 0 && (
              <div className="mt-6 flex items-start bg-blue-900/20 p-4 rounded-xl border border-blue-500/20">
                  <div className="bg-blue-500/10 p-2 rounded-lg mr-4 flex-shrink-0">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                      </svg>
                  </div>
                  <div>
                      <h4 className="text-sm font-bold text-blue-300 uppercase tracking-wider mb-1">Sugerencia para mejorar la precisión</h4>
                      <p className="text-stone-300 text-sm mb-2">Con los colores de tu paleta actual, esta es la mezcla más cercana. Para lograr un color más exacto, te sugerimos conseguir:</p>
                      <ul className="list-disc list-inside text-blue-200 font-medium">
